...
print("Fixing world folders...")
# Remove current corrupted/nested worlds
run("rm -rf /opt/vps-infra/docker/compose/minecraft/data/world")
run("rm -rf /opt/vps-infra/docker/compose/minecraft/data/world_nether")
run("rm -rf /opt/vps-infra/docker/compose/minecraft/data/world_the_end")

# Redownload world.zip if it was deleted
run("gdown 17DInA6Km6LSniWEOoGSrhdB1gQWlIYf_ -O /home/rushi/world.zip")
run("gdown 1vc08kHb-R2BbvbGkUynQRNfkjJnEqe17 -O /home/rushi/world_nether.zip")
run("gdown 19BshkDovnHqD0ll_LwrKDG4yd1RkCVSA -O /home/rushi/world_the_end.zip")
