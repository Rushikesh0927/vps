...
content = open('lib/data/product_config.dart', 'r', encoding='utf-8').read()

new_configs = """final Map<String, ProductConfiguration> productConfigs = {
...
content = re.sub(r'final Map<String, ProductConfiguration> productConfigs = \{[\s\S]*', new_configs, content)
open('lib/data/product_config.dart', 'w', encoding='utf-8').write(content)
